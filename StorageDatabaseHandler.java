...
public class StorageDatabaseHandler extends SQLiteOpenHelper {
    private static final String DB_NAME = "VKSStorageFacialImages";

    // below int is our database version
    private static final int DB_VERSION = 1;

    // below variable is for our table name.
    private static final String TABLE_NAME = "VKSStorageFacialTable";
    ...
    public StorageDatabaseHandler(Context context) {
    ...
    public boolean insert(String fileName, byte[] images, String strvalue, Float value, String datetime) {
        try{
